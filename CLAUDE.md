...
for the full branch/tool table.

**This branch is `rebuild/code` — the Claude Code rebuild.**

When implementing on this branch, Claude should:
...
- **not** read, copy, or align with the sibling rebuild branches (`rebuild/codex`, `rebuild/cursor`);
